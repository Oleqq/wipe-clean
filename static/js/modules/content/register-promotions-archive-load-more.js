...
const getCurrentSettings = (section, mediaQuery) => {
    return {
        initial: getResponsiveCount(section, mediaQuery.matches, "data-initial-desktop", "data-initial-mobile", 3),
        step: getResponsiveCount(section, mediaQuery.matches, "data-step-desktop", "data-step-mobile", 3)
    };
};
...
export const registerPromotionsArchiveLoadMore = () => {
